...
import com.fh.baselib.utils.TextDrawUtils;
	...
	private void initAttribute(AttributeSet attrs, int defStyleAttr) {
		...
		mHintCircleRadius = typeArray.getDimensionPixelOffset(R.styleable.AZSideBarView_hintCircleRadius,
															  (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 24,
																							  getResources().getDisplayMetrics()));
//		mHintCircleColor = typeArray.getColor(R.styleable.AZSideBarView_hintCircleColor, Color.parseColor("#bef9b8"));
		mHintCircleColor = typeArray.getColor(R.styleable.AZSideBarView_hintCircleColor, getResources().getColor(R.color.lightgray));
