 ...
 * 修改人：liuwan1992
 * 修改时间：2018/12/21
 * 转自： https://blog.csdn.net/liuwan1992/article/details/52701475
 */
public class CustomDatePicker implements View.OnClickListener, PickerView.OnSelectListener {
    ...
    private Boolean mCanShowDay = true;
    ...
    public void setCanShowDay(boolean bool) {
        this.mCanShowDay = bool;
        mDpvDay.setVisibility(bool?View.VISIBLE:View.GONE);
    }
}
